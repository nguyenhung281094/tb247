...
class TB247_DM_Plugin {
	...
	public static function init() {
		...
		add_action( 'rest_api_init', array( 'TB247_DM_Deals_Refresh_Rest_Controller', 'register_routes' ) );
		add_action( 'admin_notices', array( __CLASS__, 'maybe_permalink_notice' ) );
	}

	/**
	 * Đăng ký các marketplace được hỗ trợ.
	 */
	public static function register_marketplaces() {
		...
		TB247_DM_Marketplace_Registry::register( new TB247_DM_Yahoo_Marketplace() );
	}
